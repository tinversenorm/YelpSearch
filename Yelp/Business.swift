...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, more: Bool = false, completion: ([Business]!, NSError!) -> Void) {
        YelpClient.sharedInstance.searchWithTerm(term, more: more, completion: completion)
    }
